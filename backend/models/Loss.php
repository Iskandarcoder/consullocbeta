...
class Loss extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Family::className(), ['loss_id' => 'id']);
    }

    public function getLabor()
    {
        return $this->hasMany(Labor::className(), ['loss_id' => 'id']);
    }

     public function getSpCountry()
    {
        return $this->hasOne(SpCountryyii::className(), ['sp_id' => 'country_id']);
    }

     public function getSpCountry2()
    {
        return $this->hasOne(SpCountryyii::className(), ['sp_id' => 'pmj_id']);
    }

    public function getSpCountry3()
    {
    ...
    {
        return $this->hasOne(Cause::className(), ['id' => 'cause_id']);
    }

...
/**
 * This is the model class for table "sp_doctype_istreb".
 *
 ...
 */
class SpDoctypeIstreb extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['sp_name_ru', 'sp_name_uz'], 'required'],

...
<table  width="800" border="0" cellpadding="0" cellspacing="0" class="anketa-pdf" style="font-size: 15px;">
	...
	<tr>
		<td style=" padding: 5px;">
			<p style="font-size: 18px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Я,<?= $model->surname ?> <?= $model->name ?> <?= $model->mname ?>, прошу Вас оформить мне утрату гражданства Республики Узбекистан, в связи с <?= $model->cause->name_ru;?><?php if((($model->cause_id)=='1')||(($model->cause_id)=='5')){ echo " ("; echo $model->spCountry->sp_name_ru; ;  echo ")."; }else{ echo "."; }  ?></p>
		</td>		
	</tr>
</table><br><br><br><br>
<table  width="800" border="0" cellpadding="0" cellspacing="0" class="anketa-pdf" style="font-size: 15px;">

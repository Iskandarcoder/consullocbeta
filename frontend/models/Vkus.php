 ...
 */
class Vkus extends backend\models\Vkus
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'division_id', 'surname_latin', 'name_latin', 'patronym_latin', 'birth_date', 'photo', 'sex_id', 'nationality_id', 'birth_country_id', 'document_type_id', 'doc_seria', 'doc_number', 'date_begin_document', 'living_country_id', 'living_region_id', 'living_district_id', 'living_foreign_country_id', 'living_foreign_place', 'begin_date', 'arrival_date', 'creation_date', 'senstatus', 'consular_account_type', 'wed_name', 'education', 'education_date', 'which_school'], 'required'],
